...
const Home = () => {
	return (
		<>
			...
			<section className="container mx-auto">
				<div className="container border rounded-2 m-3 pb-3 pt-3   px-4 py-4">
					...
					>
						...
						event tickets? Or, you know someone who should be on hobbycue? Go ahead and
						Add your Own page
					</div>
			...
			{/* testimonials */}
			<section className=" container mx-auto" style={{ backgroundColor: '#F7F5F9' }}>
				<div className="container border rounded-2 m-3 pb-3 pt-3   px-4 py-4">
					...
					>
						...
						becomes very difficult to find or connect with like minded people. Websites
						like hobbycue.com is a great service which helps me get in touch with,
						communicate, connect, and exchange ideas with other dancers. It also
						provides the extra benefit of finding products and services that I can
						avail, which I can be assured is going to be of great quality as it comes
						recommended by people of the hobbycue community. To have discussions, to get
						visibility, and to be able to safely explore various hobbies and activities
						in my city, all under one roof, is an excellent idea and I highly recommend
						it.
					</div>

					<div className=" w-100 row gap-4 py-3">
						<div style={{ backgroundColor: '#CCC1DA' }} className=" col-lg-7 rounded-4">
							<AudioPlayer />
						</div>
